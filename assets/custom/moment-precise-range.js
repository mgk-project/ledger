...
(function(moment) {
    ...
    moment.preciseDiff = function(d1, d2, returnValueObject) {
        ...
        if (returnValueObject) {
            ...
            var thisDay1 = dDiff == 0 ? " hari ini" : " yg lalu";
            var thisDay2 = dDiff==1&&firstDateWasLater==false ? " lagi / besok" : " lagi";

//            text = firstDateWasLater==true ? ( (dDiff) ? " lagi" : hourDiff + " jam lagi") : thisDay1;

            text = firstDateWasLater==true ? " lagi" : " yg lalu";
            return buildStringFromValues(yDiff, mDiff, dDiff, hourDiff, minDiff, secDiff) + text;
        }
