...
function cekCreditnoteSupplierTransaksi($tr, $stepNumber, $paramsFilter = array(), $gate)
{
...
//    }
    ...
    $ci =& get_instance();
    $ci->load->model("Coms/ComRekeningPembantuCreditNote");
    $cs = New ComRekeningPembantuCreditNote();
//    if (sizeof($pIDs) > 0) {
...
//
    ...
    $result = array(
        "saldo_creditnote_supplier" => isset($tmpResult[0]->debet) ? $tmpResult[0]->debet : 0,
    );
