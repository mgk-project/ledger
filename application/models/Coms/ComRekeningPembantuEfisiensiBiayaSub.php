...
class ComRekeningPembantuEfisiensiBiayaSub extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subefisiensi_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subefisiensi",
        );
...
//                    $this->tableName = $table[$key]["cache"];
                        ...
                        $externID = (isset($this->inParams['static']['extern_id']) && ($this->inParams['static']['extern_id'] == 0)) ? matiHere("externID*. Please contact system administrator.") :$this->inParams['static']['extern_id'] ;
                        ...
                        $_preValues = $this->cekPreValue(
                            ...
                            $this->inParams['static']['extern4_id']
//                            $this->inParams['static']['extern5_id']
                        );
...
//                                    $this->outParams[$lCounter]["cache"][$mode]["saldo_kredit_periode"] = 0;
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $rekening_id,$extern2ID,$extern3ID,$extern4ID)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
        ...
        $this->addFilter("extern2_id='$extern2ID'");
        $this->addFilter("extern3_id='$extern3ID'");
        $this->addFilter("extern4_id='$extern4ID'");
//        $criteria = array();
