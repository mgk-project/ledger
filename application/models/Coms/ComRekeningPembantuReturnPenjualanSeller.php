...
class ComRekeningPembantuReturnPenjualanSeller extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_returnpenjualan_seller_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_returnpenjualan_seller",
        );
