...
class ComPaymentAntisourceCustomer extends MdlMother
{
...
//    private $periode = array("harian", "bulanan", "tahunan", "forever");
    ...
    {
        $this->tableName = "transaksi_payment_antisource_cache";
        $this->tableName_mutasi = "transaksi_payment_antisource_mutasi";
        $this->tableName_master = array(
            "mutasi" => "transaksi_payment_antisource_mutasi",
        );
    }
    ...
    public function pair($inParams)
    {
        ...
        if (sizeof($this->inParams['loop']) > 0) {
            ...
            foreach ($this->inParams['loop'] as $key => $value) {
                ...
                $extern_id = $externID = (isset($this->inParams['static']['extern_id']) && ($this->inParams['static']['extern_id'] != 0)) ? $this->inParams['static']['extern_id'] : mati_disini("$msg " . __LINE__);
...
//        $result = $this->db->get($tableNames[$rek]['mutasi']);
        $result = $this->db->get($this->tableName_mutasi);
//        cekkuning($this->db->last_query());
