...
class ComRekeningTransaksi extends MdlMother
{
...
//    private $periode = array("forever");
    ...
    public function __construct()
    {
        ...
        $this->tableName = "z_rekening_transaksi_cache";
        $this->tableName_master = array(
            "mutasi" => "z_rekening_transaksi_mutasi",
        );
    }
...
//                }
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $produk_id, $gudang_id, $date = NULL, $transaksi_id)
    {
        if ($date != NULL) {
