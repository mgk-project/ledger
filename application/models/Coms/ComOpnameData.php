...
class ComOpnameData extends MdlMother
{
...
//        "harga_awal",
    ...
    {
        $this->tableName = "dashboard_opname_data";
    }
...
//                        $value = $x;
                            ...
                            if (array_key_exists("id", $_preValues["cache"]) && ($_preValues["cache"]["id"] > 0)) {
                                ...
                                $p_nama = $array_params['static']['produk_nama'];
                                $p_id = $array_params['static']['produk_id'];
                                mati_disini("Data stok opname tidak lengkap, silahkan diperiksa kembali. [$p_id] [$p_nama] code: " . __LINE__);
                            }
...
//mati_disini(__LINE__);
    ...
    private function cekPreValue($jenis, $cabang_id, $produk_id, $gudang_id, $referensi_id)
    {
        $this->filters = array();
        ...
        $this->addFilter("dashboard_opname_id='$referensi_id'");
        $result = array();
        $localFilters = array();
