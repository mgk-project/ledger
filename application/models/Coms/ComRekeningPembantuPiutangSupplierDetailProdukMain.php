...
class ComRekeningPembantuPiutangSupplierDetailProdukMain extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subpiutangsupplierproduk_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subpiutangsupplierproduk",
        );
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $externNama = (isset($inParams['static']['extern_id'])) ? $inParams['static']['extern_id'] : "";
                    ...
                    $extern2Nama = (isset($inParams['static']['extern2_id'])) ? $inParams['static']['extern2_id'] : "";
...
//
                        if ($afterPosition != detectRekDefaultPosition($key) && ($afterNumber != 0)) {
                            ...
                            if ($selisih > 5){
                                mati_disini(("Saldo rekening $rekening_alias $externNama $extern2Nama tidak cukup. Anda membutuhkan $value, tersedia $preNumber. Silahkan menghubungi admin."));
...
//                            unset($pSpec_mode["tabel"]);
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $pihak_id, $pihak2_id, $produk_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
        ...
        $this->addFilter("extern3_id='$produk_id'");
//        $criteria = array();
