...
class ComRekeningPembantuEfisiensiBiayaMain extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_efisiensi_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_efisiensi",
        );
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $externID = (isset($this->inParams['static']['extern_id']) && ($this->inParams['static']['extern_id'] > 0)) ? $this->inParams['static']['extern_id'] : matiHere("unknown cexternID*. Please contact system administrator.".__LINE__);
//                    $extern2ID = (isset($this->inParams['static']['extern2_id'])) ? $this->inParams['static']['extern2_id'] : matiHere("unknown extern2ID*. Please contact system administrator.".__LINE__);
