...
class ComRekeningPembantuHutangJangkaPanjangItem extends MdlMother
{
...
//                                die(lgShowAlert("insufficient balance for $key. <br>You requested $value. <br>Available: $preNumber. <br>Post-value should be: $afterNumber"));
                                ...
                                if ($afterNumber > 1) {
                                    ...
                                    matiHEre("saldo tidak cukup untuk akun $key_alias " . $inParams['static']['extern_nama'] . ". Silahkan cek mutasi $key_alias " . $inParams['static']['extern_nama']);
                                }
                            }
                        }
