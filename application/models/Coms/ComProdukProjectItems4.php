...
class ComProdukProjectItems4 extends MdlMother
{
        ...
        if (sizeof($this->inParams) > 0) {
            ...
            foreach ($this->inParams as $cnt => $inSpec) {
                if (isset($inSpec['static']) && sizeof($inSpec['static']) > 0) {
                    ...
                    $this->load->model("Mdls/MdlProdukProjectItems4");
                    $p = new MdlProdukProjectItems4();
                    $dataBaru = array();
                    ...
                    if($ins){
                        ...
                        arrPrint($dataBaru);
                        cekLime($this->db->last_query());
                        mati_disini("gagal menulis data project. Segera hubungi admin. #4 LINE:".__LINE__);
                    }
//                    cekLime($this->db->last_query());
                }
            }
