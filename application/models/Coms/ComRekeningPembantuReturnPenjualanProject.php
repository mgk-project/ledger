...
class ComRekeningPembantuReturnPenjualanProject extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $extern2ID = (isset($this->inParams['static']['extern2_id']) && ($this->inParams['static']['extern2_id'] > 0)) ? $this->inParams['static']['extern2_id'] : die(lgShowAlert("unknown projectID*. Please contact system administrator."));
