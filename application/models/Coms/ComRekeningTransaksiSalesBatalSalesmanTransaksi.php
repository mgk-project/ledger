...
class ComRekeningTransaksiSalesBatalSalesmanTransaksi extends MdlMother
{
...
//        "gudang_nama",
    ...
    {
        // TOTAL KONSOLIDASIAN
        $this->tableName = "z_sales_batal_salesman_transaksi_cache";
        $this->tableName_master = array(
            "mutasi" => "z_sales_batal_salesman_transaksi_mutasi",
        );
    }
        ...
        if (sizeof($this->inParams) > 0) {
            ...
            foreach ($this->periode as $periode) {
                ...
                foreach ($array_params['loop'] as $key => $x) {
                    ...
                    if(!isset($array_params['static']['master_id']) || ($array_params['static']['master_id'] == 0)){
                        mati_disini("master id tidak dikenali.");
                    }
