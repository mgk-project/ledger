 ...
 * Time: 3:41 PM
 */
class ComLockerStockMutasiAktiva extends MdlMother
{
    ...
    {
        parent::__construct();
        $this->load->model("Mdls/MdlLockerStockAktivaCache");
        $this->load->model("Mdls/MdlLockerStockMutasiAktiva");
...
//                        }
                        ...
                        $c = new MdlLockerStockAktivaCache();
...
//                        $tmpCache = $c->lookUpStockSumActive($paramAsli['static']['cabang_id'], $paramAsli['static']['gudang_id'], $paramAsli['static']['extern_id']);
                    ...
                    if ($pakaimutasi == 1) {
                        ...
                        $m = new MdlLockerStockMutasiAktiva();
...
//                }
    ...
    private function cekPreValue($cabang_id, $produk_id, $gudang_id)
    {
        ...
        $this->load->model("Mdls/MdlLockerStockAktivaCache");
        $l = new MdlLockerStockAktivaCache();

        $this->addFilter("jenis='aktiva'");
