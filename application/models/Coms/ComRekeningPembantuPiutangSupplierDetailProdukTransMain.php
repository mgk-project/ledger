...
class ComRekeningPembantuPiutangSupplierDetailProdukTransMain extends MdlMother
{
...
//                    $externID = (isset($inParams['static']['transaksi_id']) && $inParams['static']['transaksi_id'] > 0) ? $inParams['static']['transaksi_id'] : mati_disini($msg);
                    ...
                    $msg = "Transaksi gagal disimpan karena supplier tidak dikenali. Silahkan hubungi admin.";
                    $produkID = (isset($inParams['static']['extern4_id']) && $inParams['static']['extern4_id'] > 0) ? $inParams['static']['extern4_id'] : mati_disini($msg);
                    ...
                    // replace
                    $inParams['static']['extern_id'] = $externID;
...
//                    $afterNumber = round($preNumber + $value);
                    ...
                    if (in_array($key, $configBalanceProtections)) {
                        if ($afterPosition != detectRekDefaultPosition($key) && ($afterNumber != 0)) {
                            $selisih = reformatExponent($afterNumber);
...
//                            unset($pSpec_mode["tabel"]);
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $pihak_id, $pihak2_id, $pihak2_id, $produk_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
