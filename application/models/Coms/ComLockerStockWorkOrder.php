 ...
 * Time: 11:09 AM
 */
class ComLockerStockWorkOrder extends CI_Model
{
...
//                matiHEre(__LINE__);
                ...
                $_preValue = $this->cekPreValue($paramAsli['static']['jenis'], $paramAsli['static']['cabang_id'], $paramAsli['static']['produk_id'], $paramAsli['static']['state'], $defaultOlehID, $defaultTransID, $defaultGudangID,$paramAsli['static']['project_id'],$paramAsli['static']['work_order_id']);
                ...
                if ($_preValue != null) {
                    ...
                    $this->outParams[$lCounter]["src_key"] = $paramAsli['static']['cabang_id'].$defaultGudangID.$paramAsli['static']['project_id'].$paramAsli['static']['work_order_id'].$paramAsli['static']['produk_id'].$paramAsli['static']['state'];
...
//        }
    ...
    private function cekPreValue($jenis, $cabang_id, $produk_id, $state = "active", $olehID = 0, $transaksiID = 0, $gudang_id,$project_id,$workorder_id)
    {
