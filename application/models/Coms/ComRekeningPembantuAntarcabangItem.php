...
class ComRekeningPembantuAntarcabangItem extends MdlMother
{
...
//                                    if (in_array($array_params['static']['jenis'], $this->accountMinusAllowedJenisTr["jenisTransaksi"])) {
//                                    }
//                                    else {
//                                        $allowMinus = false;
//                                    }
                                    if ($allowMinus == true) {
//                                    mati_disini("boleh allow minus $allowMinus, $key :: " . $array_params['static']['jenis']);
                                    }
                                    else {
