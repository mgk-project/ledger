...
class ComRekeningPembantuPiutangSupplierDetailMain extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subpiutangsupplier_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subpiutangsupplier",
        );
