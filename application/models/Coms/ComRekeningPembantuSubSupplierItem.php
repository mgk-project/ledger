...
class ComRekeningPembantuSubSupplierItem extends MdlMother
{
            ...
            foreach ($this->inParams as $array_params) {
                foreach ($this->periode as $periode) {
                    ...
                    foreach ($array_params['loop'] as $key => $value) {
                        ...
                        $msg3 = "Transaksi Gagal disimpan karena ID Transaksi tidak dikenal. Silahkan hubungi admin. code: " . __LINE__;
                        $pihakID = ($array_params['static']['extern_id'] > 0) ? $array_params['static']['extern_id'] : mati_disini($msg);
                        $pihakNama = $array_params['static']['extern_nama'];
                        $pihak2ID = ($array_params['static']['extern2_id'] > 0) ? $array_params['static']['extern2_id'] : mati_disini($msg2);
                        $pihak2Nama = $array_params['static']['extern2_nama'];
                        $transaksiID = ($array_params['static']['transaksi_id'] > 0) ? $array_params['static']['transaksi_id'] : mati_disini($msg3);
                        $transaksiNomer = $array_params['static']['transaksi_no'];
                        ...
                        if (in_array($jenis, $this->jenisTrSwitchTrID)) {
                            ...
                            $array_params['static']['extern_id'] = $pihakID;
                            $array_params['static']['extern_nama'] = $pihakNama;
                        }
                        else {
                            if (in_array($jenis, $this->jenisTrBatal) && ($rejection == 1)) {
                                $pihakID = $array_params['static']['reference_id'];
                                $pihakNama = $array_params['static']['reference_nomer'];
                                $array_params['static']['extern_id'] = $array_params['static']['reference_id'];
                                $array_params['static']['extern_nama'] = $array_params['static']['reference_nomer'];
                            }
                        }
