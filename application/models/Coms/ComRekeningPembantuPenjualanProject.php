...
class ComRekeningPembantuPenjualanProject extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_penjualan_project_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_penjualan_project",
        ...
        if (sizeof($this->inParams['loop']) > 0) {
            ...
            foreach ($this->periode as $periode) {
                ...
                foreach ($this->inParams['loop'] as $key => $value) {
                    ...
                    $extern2ID = (isset($this->inParams['static']['extern2_id']) && ($this->inParams['static']['extern2_id'] > 0)) ? $this->inParams['static']['extern2_id'] : mati_disini(("unknown projectID*. Please contact system administrator."));
                    ...
                    if (in_array($key, $configBalanceProtections)) {
                        if ($afterPosition != detectRekDefaultPosition($key) && ($afterNumber != 0)) {
                            mati_disini(("saldo tidak cukup $key " . $this->inParams['static']['extern_nama'] . ""));
                        }
                    }
