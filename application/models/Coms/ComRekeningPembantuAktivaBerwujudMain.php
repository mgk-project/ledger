...
class ComRekeningPembantuAktivaBerwujudMain extends MdlMother
{
...
//                foreach ($this->inParams as $this->inParams) {
                $arrRekening = array();
                foreach ($this->inParams['loop'] as $key => $x) {
//                        $lCounter++;

                    $value_item = $this->inParams['static']['produk_nilai'];
                    $unit = 1; //ini default 1 karena hanya nambah value saja tidak nambaha qty nya

                    $value = $value_item * $unit;//ini default 1 karena hanya nambah value saja tidak nambaha qty nya
