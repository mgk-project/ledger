...
class ComProdukProjectItems7 extends MdlMother
{
        ...
        if (sizeof($this->inParams) > 0) {
            ...
            foreach ($this->inParams as $cnt => $inSpec) {
                if (isset($inSpec['static']) && sizeof($inSpec['static']) > 0) {
                    ...
                    $this->load->model("Mdls/MdlProdukProjectItems7");
                    $p = new MdlProdukProjectItems7();
                    $dataBaru = array();
                    ...
                    $p->addData($dataBaru) or mati_disini("gagal menulis data project. Segera hubungi admin. #7");
