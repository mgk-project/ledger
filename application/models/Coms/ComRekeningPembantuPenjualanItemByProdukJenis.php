...
class ComRekeningPembantuPenjualanItemByProdukJenis extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_penjualan_produkjenis_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_penjualan_produkjenis",
        );
