...
class ComRekeningPembantuCustomerProjectDetail extends MdlMother
{
...
//                                }
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $pihak_id, $pihak2_id, $pihak3_id, $fulldate)
    {
        if (isset($fulldate)) {
