...
class ComTransaksiProduk extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "z_transaksi_produk_cache";
        $this->tableName_master = array(
            "mutasi" => "z_transaksi_produk_mutasi",
        );
    }
...
//                        $gudangID = isset($array_params['static']['gudang_id']) ? $array_params['static']['gudang_id'] : "";
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $produk_id, $gudang_id, $date = NULL, $extern2_id)
    {
        if ($date != NULL) {
