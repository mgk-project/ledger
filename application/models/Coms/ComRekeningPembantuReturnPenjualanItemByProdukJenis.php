...
class ComRekeningPembantuReturnPenjualanItemByProdukJenis extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_returnpenjualan_produkjenis_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_returnpenjualan_produkjenis",
        );
