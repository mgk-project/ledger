...
/**
 * Class ComRekeningPembantuHutangBpjs
 * struktur rekening dan pembantu
 *  |hutang bpjs                ->main comRekening
 *  | -- hutang bpjs pusat      ->pembantu level 1  ComRekeningPembantuHutangBpjs
 *  | ----- ketenaga kerjaan    ->pembantu level 2  ComRekeningPembantuSubHutangBpjs
 *  | ----- kesehatan
 *  | ----- pensiun
 *  | -- hutang bpjs karyawan
 *  | ----- ketenaga kerjaan
 *  | ----- kesehatan
 *  | ----- pensiun
 */
class ComRekeningPembantuSubHutangBpjs extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subhutangbpjs_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subhutangbpjs",
        );
