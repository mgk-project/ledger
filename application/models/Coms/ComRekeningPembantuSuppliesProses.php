...
class ComRekeningPembantuSuppliesProses extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "_rek_pembantu_supplies_proses_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_supplies_proses",
        );
    }
...
//                        $this->tableName = $table[$key]["cache"];
                        ...
                        cekKuning(":: $afterQtyNumber = $preQtyNumber + $unit ::");
                        ...
                        if (in_array($key, $configBalanceProtections)) {
                            if ($afterPosition != detectRekDefaultPosition($key)) {
                                $pid = $array_params['static']['id'];
                                $pnama = $array_params['static']['nama'];
                                mati_disini(("insufficient balance for $key. after qty: $afterQtyNumber, after position: $afterPosition, [$pid $pnama]"));
