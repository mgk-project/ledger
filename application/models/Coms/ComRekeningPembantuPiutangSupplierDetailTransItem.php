...
class ComRekeningPembantuPiutangSupplierDetailTransItem extends MdlMother
{
...
//                                $jenis = 9911;
//                                $jenis = NULL;
                                if ($array_params['static']['jenis'] == $this->jenis_pembatalan) {
                        ...
                        $extern2Nama = (isset($array_params['static']['extern2_nama'])) ? $array_params['static']['extern2_nama'] : "";
                        $msg = "Transaksi gagal disimpan karena supplier tidak dikenali. Silahkan hubungi admin.";
                        ...
                        $extern3Nama = (isset($array_params['static']['extern3_nama'])) ? $array_params['static']['extern3_nama'] : "";
