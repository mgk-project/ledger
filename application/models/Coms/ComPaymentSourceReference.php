 ...
 * Time: 11:09 AM
 */
class ComPaymentSourceReference extends MdlMother
{
...
//                matiHere("Gagal menyimpan transaksi, silahkan hubungi tim developer untuk melakukan pengecekan sistem. Error Code:  Com " . __LINE__);
                $this->writeMode = "new";
                // tidak ada paymentsource ya lewat saja...
            }
        }
        return true;
...
//        }
    ...
    private function cekPreValue($jenis, $cabang_id, $extern_id, $extern2_id, $label)
    {
...
//                            "extern_label2" => $params['extern_label2'],
                        ...
                        break;
                    default:
//                        mati_disini("operasional transaksi ini tidak diketahui. code: <span class='meta'>" . __LINE__ ." " .get_class($this). " " . __FUNCTION__ . "</span>");
                        $insertIDs[] = 1;
                        break;
                }
