...
class ComRekeningPembantuHppProjectWorkorderDetail extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_hpp_project_wodetail_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_hpp_project_wodetail",
...
//                    $externID = (isset($array_params['static']['extern_id']) && ($array_params['static']['extern_id'] > 0)) ? $array_params['static']['extern_id'] : die(lgShowAlert("unknown customerID*. Please contact system administrator."));
                        ...
                        $extern3ID = (isset($array_params['static']['extern3_id']) && ($array_params['static']['extern3_id'] > 0)) ? $array_params['static']['extern3_id'] : 0;
...
//                            arrPrint($pSpec_mode);
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $rekening_id, $rekening2_id, $rekening3_id, $fulldate)
    {
        if (isset($fulldate)) {
