...
class ComRekeningPembantuAktivaBelumDitempatkan extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "_rek_pembantu_subaktivatetap_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subaktivatetap",
        ...
        if (sizeof($this->inParams) > 0) {
            ...
            foreach ($this->periode as $periode) {
                if (isset($this->inParams['loop'])) {
                    foreach ($this->inParams['loop'] as $key => $x) {
//                        $lCounter++;
...
//                        $this->tableName = $table[$key]["cache"];
                        ...
                        $_preValues = $this->cekPreValue($key, $this->inParams['static']['cabang_id'], $periode, $this->inParams['static']['extern_id'], $this->inParams['static']['gudang_id'], $this->inParams['static']['fulldate']);
