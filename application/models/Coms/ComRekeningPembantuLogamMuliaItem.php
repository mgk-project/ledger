...
class ComRekeningPembantuLogamMuliaItem extends MdlMother
{
...
//                        }
                        ...
                        if (in_array($key, $configBalanceProtections)) {
                            if ($afterPosition != detectRekDefaultPosition($key) && ($afterQtyNumber != 0)) {
                                ...
                                cekMerah("Saldo tidak cukup untuk $key, $pName. Anda membutuhkan $value, tersedia $preNumber. Silahkan menghubungi admin.");
