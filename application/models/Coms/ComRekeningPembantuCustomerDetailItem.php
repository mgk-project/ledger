...
class ComRekeningPembantuCustomerDetailItem extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subcustomer_cache";
            ...
            foreach ($this->periode as $periode) {
                foreach ($this->inParams as $array_params) {
                    ...
                    foreach ($array_params['loop'] as $key => $value) {
                        ...
                        $unit = $qty = (isset($array_params['static']['qty']) && ($array_params['static']['qty'] != NULL)) ? $array_params['static']['qty'] : 0;
                        ...
                        $afterQtyNumber = $preQtyNumber + $qty;
