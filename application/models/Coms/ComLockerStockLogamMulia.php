...
class ComLockerStockLogamMulia extends MdlMother
{
...
//                    $msg_4 = "Transaksi gagal disimpan karena id gudang login tidak terdaftar. silahkan relogin atau hubungi admin.";
                    ...
                    $reverted_target = isset($paramAsli['static']['reverted_target']) ? $paramAsli['static']['reverted_target'] : NULL;
...
//                        $defaultTransID = isset($paramAsli['static']['referenceID']) ? $paramAsli['static']['referenceID'] : 0;
////                        switch($reverted_target){
////                            case "1676":
////                                $defaultTransID = isset($paramAsli['static']['referenceID_top']) ? $paramAsli['static']['referenceID_top'] : 0;
////                                break;
////                        }
//                    }
                    ...
                    if ($pakai_exec == 1) {
                        if (sizeof($this->outParams) > 0) {
                            ...
                            foreach ($this->outParams as $ctr => $params) {
                                $this->load->model("Mdls/MdlLockerStockLogamMulia");
                                $l = new MdlLockerStockLogamMulia();
                                $insertIDs = array();
                                $mode = $params['mode'];
                                unset($params['mode']);
...
//            $result = $tmp['jumlah'];
    ...
    //-------
//    private function cekLockerValidate($jenis, $jenis_item, $cabang_id, $produk_id, $qty_kiriman = 0)
//    {
//
//        //region locker stok
//        $this->load->model("Mdls/MdlLockerStockLogamMulia");
