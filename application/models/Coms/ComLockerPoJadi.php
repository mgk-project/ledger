 ...
 * Time: 11:09 AM
 */
class ComLockerPoJadi extends CI_Model
{
...
//                    echo $this->outParams[$lCounter]["jumlah"];
//                    echo $paramAsli['jumlah'];
                } else {
                    $this->writeMode = "new";
                }

//                $this->outParams[$lCounter][$lCounter]["produk"] = $value;

//                if (sizeof($paramAsli['static']) > 0) {
//                    foreach ($paramAsli['static'] as $key => $value) {
//                        echo "static: $key diisi $value <br>";
//                        $this->outParams[$lCounter][$key] = $value;
//                    }
//                }
    ...
    private function cekPreValue($jenis, $cabang_id, $produk_id, $state = "active", $olehID = 0, $transaksiID = 0)
    {
        ...
        $this->load->model("Mdls/MdlLockerPoJadi");
        $l = new MdlLockerPoJadi();
