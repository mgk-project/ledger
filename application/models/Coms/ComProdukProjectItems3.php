...
class ComProdukProjectItems3 extends MdlMother
{
        ...
        if (sizeof($this->inParams) > 0) {
            ...
            foreach ($this->inParams as $cnt => $inSpec) {
                if (isset($inSpec['static']) && sizeof($inSpec['static']) > 0) {
                    ...
                    $this->load->model("Mdls/MdlProdukProjectItems3");
                    $p = new MdlProdukProjectItems3();
                    $dataBaru = array();
                    ...
                    $p->addData($dataBaru) or mati_disini("gagal menulis data project. Segera hubungi admin. #3");
