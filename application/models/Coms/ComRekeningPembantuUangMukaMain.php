...
class ComRekeningPembantuUangMukaMain extends MdlMother
{
                            ...
                            if (in_array($key, $configBalanceProtections)) {
                                if ($afterPosition != detectRekDefaultPosition($key) && ($afterNumber != 0)) {
                                    ...
                                    if ($afterNumber > 1) {
                                        ...
                                        $text = "$key_alias $extern_nama";
                                        $text_blob = blobEncode($text);
                                        $link = base_url() . "Ledger/viewMoveDetails/RekeningPembantuUangMukaReference/$key/$extern_id/?o=$cabang_id&main_ext2_id=$extern_id&blob_ext=$text_blob";
