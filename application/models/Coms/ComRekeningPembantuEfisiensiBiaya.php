...
class ComRekeningPembantuEfisiensiBiaya extends MdlMother
{
            ...
            foreach ($this->periode as $periode) {
                foreach ($this->inParams as $array_params) {
                    ...
                    foreach ($array_params['loop'] as $key => $value) {
                        ...
                        $value_item = isset($array_params['static']['produk_nilai']) ? trim($array_params['static']['produk_nilai']) : 0;
                        $unit = isset($array_params['static']['produk_qty']) ? trim($array_params['static']['produk_qty']) : 0;
                        ...
                        $_preValues = $this->cekPreValue($key, $array_params['static']['cabang_id'], $periode, $array_params['static']['extern_id'], $array_params['static']['extern2_id']);
                        ...
                        cekMerah(":: $key :: $afterNumber :: $afterPosition ::");
