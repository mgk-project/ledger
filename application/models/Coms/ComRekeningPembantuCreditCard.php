...
class ComRekeningPembantuCreditCard extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_creditcard_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_creditcard",
        );
    }
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $msg = "Silahkan memilih sumber pembayaran (Credit Card terdaftar) sebelum melanjutkan transaksi.";
