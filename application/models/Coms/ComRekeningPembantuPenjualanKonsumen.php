...
class ComRekeningPembantuPenjualanKonsumen extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_penjualan_konsumen_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_penjualan_konsumen",
        );
