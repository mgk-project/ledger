...
class ComRekeningTransaksiSalesReturnSalesmanPembantu extends MdlMother
{
...
//        "cabang_nama",
    ...
    public function __construct()
    {
        ...
        $this->tableName = "z_sales_return_salesman_pembantu_cache";
        $this->tableName_master = array(
            "mutasi" => "z_sales_return_salesman_pembantu_mutasi",
        );
    }
...
//    private function cekPreValue($rek, $cabang_id, $periode, $produk_id, $gudang_id, $date = NULL, $master_id, $transaksi_id, $extern2_id, $seller_id)
    private function cekPreValue($rek, $periode, $produk_id, $date = NULL, $transaksi_id, $seller_id)
    {
        if ($date != NULL) {
            $date_ex = explode("-", $date);
            $tgl = $date_ex[2];
