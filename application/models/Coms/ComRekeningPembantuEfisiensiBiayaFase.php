...
class ComRekeningPembantuEfisiensiBiayaFase extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_subefisiensi_fase_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_subefisiensi_fase",
...
//                                                            cekUngu("$sub_mode :: " . $this->db->last_query());
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $rekening_id, $rekening2_id, $extern3_id, $produk_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
