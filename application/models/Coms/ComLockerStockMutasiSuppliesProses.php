 ...
 * Time: 3:41 PM
 */
class ComLockerStockMutasiSuppliesProses extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->load->model("Mdls/MdlLockerStockMutasiSuppliesProses");
    }
...
//                arrPrint($paramAsli);
                ...
                if ($_preValue != null) {
                    ...
                    if ($pakaicache == 1) {
                        ...
                        $c = new MdlLockerStockSuppliesProsesCache();
...
//                        $tmpCache = $c->lookUpStockSumActive($paramAsli['static']['cabang_id'], $paramAsli['static']['gudang_id'], $paramAsli['static']['extern_id']);
                    ...
                    if ($pakaimutasi == 1) {
                        ...
                        $m = new MdlLockerStockMutasiSuppliesProses();
...
//matiHEre();
    ...
    private function cekPreValue($cabang_id, $produk_id, $gudang_id)
    {
        ...
        $this->load->model("Mdls/MdlLockerStockSuppliesProsesCache");
        $l = new MdlLockerStockSuppliesProsesCache();

        $this->addFilter("jenis='supplies_proses'");
