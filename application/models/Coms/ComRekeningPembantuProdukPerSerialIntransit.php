...
class ComRekeningPembantuProdukPerSerialIntransit extends MdlMother
{
...
//    private $periode = array("harian", "bulanan", "tahunan", "forever");
    ...
    {
        $this->tableName = "_rek_pembantu_produk_perserial_intransit_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_produk_perserial_intransit",
        );
    }
