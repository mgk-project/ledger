...
class ComRekeningTransaksiSalesReturnCabangPembantu extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "z_sales_return_cabang_pembantu_cache";
        $this->tableName_master = array(
            "mutasi" => "z_sales_return_cabang_pembantu_mutasi",
        );
    }
