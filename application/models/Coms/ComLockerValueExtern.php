 ...
 * Time: 11:09 AM
 */
class ComLockerValueExtern extends MdlMother
{
...
//                    if (base64_decode($paramAsli['static']['transaksi_id'], true) === true) {
            ...
            $externID = isset($paramAsli['static']['extern_id']) ? $paramAsli['static']['extern_id'] : 0;
            ...
            if ($_preValue != null) {
                ...
                //cekPink("preValue: $_preValue :: locker value hasil: " . $this->outParams[$lCounter]["nilai"]);

                if (floor($this->outParams[$lCounter]["nilai"]) < 0) {
    ...
    private function cekPreValue($jenis, $cabang_id, $produk_id, $state = "active", $olehID = 0, $transaksiID = 0, $gudang_id, $extern_id)
    {
