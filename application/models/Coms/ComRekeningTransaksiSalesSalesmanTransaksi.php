...
class ComRekeningTransaksiSalesSalesmanTransaksi extends MdlMother
{
...
//        "gudang_nama",
    ...
    {
        // TOTAL KONSOLIDASIAN
        $this->tableName = "z_sales_salesman_transaksi_cache";
        $this->tableName_master = array(
            "mutasi" => "z_sales_salesman_transaksi_mutasi",
        );
    }
