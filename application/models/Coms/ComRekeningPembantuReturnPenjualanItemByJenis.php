...
class ComRekeningPembantuReturnPenjualanItemByJenis extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_returnpenjualan_jenis_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_returnpenjualan_jenis",
        );
