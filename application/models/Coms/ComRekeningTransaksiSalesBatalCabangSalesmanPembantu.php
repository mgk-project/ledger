...
class ComRekeningTransaksiSalesBatalCabangSalesmanPembantu extends MdlMother
{
    ...
    {
        $this->tableName = "z_sales_batal_cabang_salesman_pembantu_cache";
        $this->tableName_master = array(
            "mutasi" => "z_sales_batal_cabang_salesman_pembantu_mutasi",
        );
    }
