...
class ComRekeningPembantuCustomerValasItem extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                        ...
                        $qty = isset($array_params['static']['qty']) ? $array_params['static']['qty'] : 0;
                        arrPrint($_preValues);
//cekHitam("$qty *&*&^%$");
//arrPrint($_preValues);
...
//                    }
                        ...
                        $afterqty = $preQty + $qty;
                        cekHere("afterQTY : $afterqty = $preQty + $qty;");
