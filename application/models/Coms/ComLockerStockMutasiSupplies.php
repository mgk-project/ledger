 ...
 * Time: 3:41 PM
 */
class ComLockerStockMutasiSupplies extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->load->model("Mdls/MdlLockerStockMutasiSupplies");
//        $this->load->model("Mdls/MdlLockerStock");
//        $this->tableName = "stock_locker_cache";
    }

    public function pair_($inParams)
    {
...
//                        }
                        ...
                        $c = new MdlLockerStockSuppliesCache();
...
//                        $tmpCache = $c->lookUpStockSumActive($paramAsli['static']['cabang_id'], $paramAsli['static']['gudang_id'], $paramAsli['static']['extern_id']);
                    ...
                    if ($pakaimutasi == 1) {
                        ...
                        $m = new MdlLockerStockMutasiSupplies();
...
//                }
    ...
    private function cekPreValue($cabang_id, $produk_id, $gudang_id)
    {
        ...
        $this->load->model("Mdls/MdlLockerStockSuppliesCache");
        $l = new MdlLockerStockSuppliesCache();

        $this->addFilter("jenis='supplies'");
