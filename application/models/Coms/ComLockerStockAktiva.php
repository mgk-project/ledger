 ...
 * Time: 11:09 AM
 */
class ComLockerStockAktiva extends CI_Model
{
            ...
            foreach ($this->inParams as $lCtr => $paramAsli) {
                ...
                if ($_preValue != null) {
                    ...
                    if ($this->outParams[$lCounter]["jumlah"] < 0) {
                        ...
                        $msg = "*".$paramAsli['static']['produk_id']."* transaksi gagal, karena " . html_escape($paramAsli['static']['nama']) . " state " . $paramAsli['static']['state'] . ", needed: " . $paramAsli['static']['jumlah'] . ", avail: 0";
