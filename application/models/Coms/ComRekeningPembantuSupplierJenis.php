...
class ComRekeningPembantuSupplierJenis extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_supplier_jenis_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_supplier_jenis",
        );
...
//                    arrPrint($this->outParams);
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $pihak_id)
    {
        ...
        $this->addFilter("extern_id='$pihak_id'");// lokal / import
//        $this->addFilter("extern2_id='$pihak_id'");
