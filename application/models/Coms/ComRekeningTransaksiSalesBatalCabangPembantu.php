...
class ComRekeningTransaksiSalesBatalCabangPembantu extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "z_sales_batal_cabang_pembantu_cache";
        $this->tableName_master = array(
            "mutasi" => "z_sales_batal_cabang_pembantu_mutasi",
        );
    }
