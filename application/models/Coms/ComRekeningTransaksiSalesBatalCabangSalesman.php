...
class ComRekeningTransaksiSalesBatalCabangSalesman extends MdlMother
{
    ...
    {
        // TOTAL KONSOLIDASIAN
        $this->tableName = "z_sales_batal_cabang_salesman_cache";
        $this->tableName_master = array(
            "mutasi" => "z_sales_batal_cabang_salesman_mutasi",
        );
    }
