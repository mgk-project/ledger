...
class ComRekeningPembantuProdukRiilKoreksiNilai extends MdlMother
{
...
//                                    }
                        ...
                        if($periode=="forever"){
                            $updateFifoAvg = array(
                                "hpp_riil"=>$afterNumberAvg,
                                "jml_nilai_riil"=>$afterNumber,
                            );
                            ...
                            $f->updateData($whereFifo,$updateFifoAvg) or matiHere("gagal memperbaharui fifo");
