...
class ComKoreksiRekeningPembantuProdukRiilSaldo extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "_rek_pembantu_produk_riil_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_produk_riil",
        );
    }
                        ...
                        if ($pakai_cache == 1) {
                            ...
                            switch ($position) {
                                case "kredit":
                                    ...
                                    $this->outParams[$lCounter]["cache"][$mode]["saldo_qty_kredit_periode"] = $_preValues["cache"]["saldo_qty_kredit_periode"];
                                    break;
                                case "debet":
                                    ...
                                    $this->outParams[$lCounter]["cache"][$mode]["saldo_qty_debet"] = $_preValues["cache"]["saldo_qty_debet"];
                                    $this->outParams[$lCounter]["cache"][$mode]["saldo_qty_debet_periode"] = $_preValues["cache"]["saldo_qty_debet_periode"];
