...
class ComRekeningPembantuCustomerDetail extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $unit = $qty = (isset($inParams['static']['qty']) && ($inParams['static']['qty'] != NULL)) ? $inParams['static']['qty'] : 0;
...
//        cekkuning($this->db->last_query());
    ...
    public function fetchMoves($rek, $externID, $subExternID)
    {//==memanggil saldo2 dari rekening tertentu
        $tableNames = heReturnTableName($this->tableName_master, array($rek));
        if ($subExternID != NULL) {
            if ($externID != NULL) {
