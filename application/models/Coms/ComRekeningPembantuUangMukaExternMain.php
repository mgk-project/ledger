...
class ComRekeningPembantuUangMukaExternMain extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_uang_muka_subvalas_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_uang_muka_subvalas",
        );
                    ...
                    if (sizeof($this->inParams['loop']) > 0) {
                        foreach ($this->periode as $periode) {
                            ...
                            foreach ($this->inParams['loop'] as $key => $value) {
                                $lCounter++;
                                $qtyValue = $this->inParams['static']['qty'];
                                ...
                                $_preValues = $this->cekPreValue($key, $this->inParams['static']['cabang_id'], $periode, $this->inParams['static']['extern_id'], $this->inParams['static']['extern2_id']);
                                ...
                                $afterQtyNumber = round($preNumber + $qtyValue);
                                ...
                                if ($pakai_cache == 1) {
                                    ...
                                    switch ($position) {
                                        case "kredit":
                                            ...
                                            $this->outParams[$lCounter]["cache"][$mode]["saldo_qty_kredit"] = $_preValues["cache"]["saldo_qty_kredit"] + abs($qtyValue);
                                            $this->outParams[$lCounter]["cache"][$mode]["saldo_qty_kredit_periode"] = $_preValues["cache"]["saldo_qty_kredit_periode"] + abs($qtyValue);
                                            break;
                                        case "debet":
                                            ...
                                            $this->outParams[$lCounter]["cache"][$mode]["saldo_qty_debet"] = $_preValues["cache"]["saldo_qty_debet"] + abs($qtyValue);
                                            $this->outParams[$lCounter]["cache"][$mode]["saldo_qty_debet_periode"] = $_preValues["cache"]["saldo_qty_debet_periode"] + abs($qtyValue);
                                        ...
                                        case "forever":
                                            ...
                                            switch ($position) {
                                                case "debet":
                                                    ...
                                                    $this->outParams[$lCounter]["mutasi"]["qty_debet"] = abs($qtyValue);
                                                ...
                                                case "kredit":
                                                    ...
                                                    $this->outParams[$lCounter]["mutasi"]["qty_kredit"] = abs($qtyValue);
                                            ...
                                            switch ($afterQtyPosition) {
                                                case "kredit":
                                                    ...
                                                    $this->outParams[$lCounter]["mutasi"]["qty_kredit_akhir"] = abs($afterNumber);
                                                ...
                                                case "debet":
                                                    //  region cache rekening umum
                                                    $this->outParams[$lCounter]["mutasi"]["qty_debet_awal"] = $_preValues["cache"]["qty_debet"];
                                                    $this->outParams[$lCounter]["mutasi"]["qty_debet_akhir"] = abs($afterNumber);
                ...
                if (sizeof($this->inParams['loop']) > 0) {
                    foreach ($this->periode as $periode) {
                        ...
                        foreach ($this->inParams['loop'] as $key => $value) {
                            ...
                            $afterNumber = round($preNumber + $value);
                            $afterPosition = detectRekPosition($key, $afterNumber);
                            $afterQtyNumber = round($preQtyNumber + $qtyValue);
                            $afterQtyPosition = detectRekPosition($key, $afterQtyNumber);
