...
class ComRekeningPembantuBudgetProject extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_budget_project_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_budget_project",
...
//                                    $this->outParams[$lCounter]["cache"][$mode]["saldo_kredit_periode"] = 0;
    ...
    private function cekPreValue($rek, $produk_id,$cabang_id, $periode, $rekening_id, $rekening2_id,$gudangID,$gudang2ID)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
