...
class ComRekeningPembantuKerugian extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_kerugian_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_kerugian",
        );
...
//                    $this->tableName = $table[$key]["cache"];
                    ...
                    $_preValues = $this->cekPreValue($key, $inParams['static']['cabang_id'], $periode, $inParams['static']['extern_id'], $inParams['static']['extern2_id'], $inParams['static']['fulldate']);
