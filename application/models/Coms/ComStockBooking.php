 ...
 * Time: 11:09 AM
 */
class ComStockBooking extends CI_Model
{
                    ...
                    if ($_preValues != null) {
                        ...
                        if ($this->outParams[$lCounter]["jumlah"] < 0) {
                            ...
                            if ($kategori_produk == "4") {
                                ...
                                $msg = "***stok tidak cukup $kategori_produk" . $paramAsli['static']['nama'] . " with state: " . $paramAsli['static']['state'] . ", needed: " . $paramAsli['static']['jumlah'] . ", avail: " . $_preValue;
                                mati_disini($msg);
                                die(lgShowAlert($msg));
                            }
