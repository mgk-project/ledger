...
class MdlSupplierAddress extends MdlMother
{
    ...
    protected $search;
    protected $filters = array("jenis='shipment'", "extern_type='supplier'", "status='1'", "trash='0'");
    ...
    protected $fields = array(
        ...
        "kelurahan" => array(
            "label"     => "kelurahan",
            "type"      => "int", "length" => "255", "kolom" => "kelurahan",
            "inputType" => "text",
            //--"inputName" => "alamat",
        ),
        "kecamatan" => array(
            "label"     => "kecamatan",
            "type"      => "int", "length" => "255", "kolom" => "kecamatan",
            "inputType" => "text",
            //--"inputName" => "alamat",
        ),
        "kabupaten" => array(
