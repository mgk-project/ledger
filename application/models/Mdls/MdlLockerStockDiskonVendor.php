...
class MdlLockerStockDiskonVendor extends MdlMother
{
...
//        "produk.label",
    ...
    {
        parent::__construct();
        $this->tableName = "stock_locker_diskon";
        $this->indexFields = "id";
        $this->fields = array(
            "id" => array(
                "label" => "id",
    ...
    public function cekLoker($cab, $prod, $state, $oleh = 0, $transaksi_id = 0, $gudang_id, $supplierID)
    {
