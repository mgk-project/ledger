...
class MdlLockerStockLogamMulia extends MdlMother
{
    ...
    protected $filters = array(
        "jenis_locker='stock'",
        "stock_locker_logam_mulia.jenis='logam_mulia'",
    );
    ...
    protected $listedFieldsSelectItem = array(//===kolom2 yang dibaca saat searching. silahkan di-override di model masing2 jika kolomnya kurang
        "dta_logam_mulia.id",
        "dta_logam_mulia.nama",
//        "dta_logam_mulia.barcode",
//        "dta_logam_mulia.kode",
//        "dta_logam_mulia.label",
//
    );
    ...
    {
        parent::__construct();
        $this->tableName = "stock_locker_logam_mulia";
        $this->indexFields = "id";
        $this->fields = array(
            "id" => array(
                "label" => "id",
...
//    }
    ...
    public function lookupByKeyword($key)
    {
        ...
        $this->db->join('dta_logam_mulia', "dta_logam_mulia.id = " . $this->tableName . ".produk_id ");
