...
class MdlMasterCache extends MdlMother
{
    protected $tableName = "_rek_master_cache";
    ...
    public function callPenjulanPeriode($periode)
    {
        // $srcs = $this->lookupByCondite()->result();
