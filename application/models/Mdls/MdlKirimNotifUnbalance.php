...
class MdlKirimNotifUnbalance extends MdlMother
{
    protected $tableName = "kirim_notif_unbalance";
    ...
    protected $validationRules = array(//        "nama" => array("required", "singleOnly"),
...
//            "strField"        => "nama",
        ...
        "rekening" => array(
            "label" => "rekening",
            "type" => "text", "length" => "255", "kolom" => "rekening",
            "inputType" => "text",
            //--"inputName" => "nama",
//            "strField"        => "nama",
            "editable" => false,
        ...
        "nomer" => array(
            "label" => "nomer",
            "type" => "text", "length" => "255", "kolom" => "nomer",
            "inputType" => "text",
            //--"inputName" => "nama",
//            "strField"        => "nama",
            "editable" => false,
