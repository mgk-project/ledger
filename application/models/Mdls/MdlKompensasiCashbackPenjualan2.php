...
class MdlKompensasiCashbackPenjualan2 extends MdlMother_static
{
    ...
    protected $staticData = array(
        array(
            ...
            "name" => "CASH/TUNAI",
            "coa_code" => "1010010010",
            "notif" => "<h4><b><r>Cash/Akun Bank ditentukan saat pembayaran komisi oleh DC/PUSAT (dari menu Transaksi, Pembayaran, Komisi AP Payment).</r></b></h4>",
        ),
        array(
            "id" => "2",
            "name" => "CREDIT NOTE",
