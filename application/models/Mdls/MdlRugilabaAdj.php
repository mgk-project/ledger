...
class MdlRugilabaAdj extends MdlMother
{
    protected $tableName = "rugilaba_adj";
...
//        $this->db->where($criteria);
    ...
    public function fetchBalancesRange()
    {
...
//                $saldo = $debet - $kredit;
                ...
                if(!isset($tmpLastResult[$rekening]['debet'])){
                    $tmpLastResult[$rekening]['debet'] = 0;
                }
                if(!isset($tmpLastResult[$rekening]['kredit'])){
                    $tmpLastResult[$rekening]['kredit'] = 0;
                }
                if(!isset($tmpLastResult[$rekening]['saldo'])){
                    $tmpLastResult[$rekening]['saldo'] = 0;
                }
                $tmpLastResult[$rekening]['debet'] += $debet;
                $tmpLastResult[$rekening]['kredit'] += $kredit;
                $tmpLastResult[$rekening]['saldo'] += $saldo;
