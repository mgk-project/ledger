 ...
 * Time: 3:41 PM
 */
class MdlLockerPlafonHutangBankMutasi extends MdlMother
{
    protected $tableName = "stock_locker_mutasi";
    protected $tableName_data = "dta_plafon_hutang_bank";
    protected $filters = array("jenis='plafon hutang bank'");
    protected $listedFieldsSelectItem = array();
    protected $fields = array();
    protected $moveFields= array(
        "date"=>"date",
        "transaksi_jenis"=>"note",
        "oleh_nama"=>"by",
        "transaksi_no" =>"receipt number",
    );


    public function getMoveFields()
    {
        return $this->moveFields;
    }


    public function setMoveFields($moveFields)
    {
...
//        $this->db->where(array("jenis" => "plafon hutang bank"));
        ...
        $result = $this->db->get("stock_locker_mutasi");
