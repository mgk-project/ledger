...
class MdlProdukDiskonSupplierMethodStatic extends MdlMother_static
{
...
//        "trash='0'",
    ...
    protected $fields = array(
        ...
        "mdl_name" => array(
            "label" => "name",
            "type" => "int", "length" => "64", "kolom" => "mdl_name",
            "inputType" => "text",
        ),
        "mdl_name_src" => array(
            "label" => "name",
    ...
    protected $staticData = array(
        array(
            ...
            "nama" => "nota",
            "label" => "nota",
            "mdl_name" => "MdlNotaItem",
            "mdl_name_src" => "MdlNotaItem",
        ),
        array(
            "id" => "2",
            "nama" => "barang",
            ...
            "label" => "barang",
            "mdl_name" => "MdlProduk",
            "mdl_name_src" => "MdlProduk",
        ),
        array(
            "id" => "3",
            "nama" => "diskon_lain",
            "name" => "diskon_lain",
            "label" => "selain nota dan barang",
            "mdl_name" => "MdlSupplierDiskon",
            "mdl_name_src" => "MdlSupplierDiskon",
        ),
