...
class MdlModelOutdoor extends MdlMother
{
    protected $tableName = "produk_outdoor";
...
//        "barcode" => array("required"),
    ...
    protected $listedFieldsView = array("nama", "sku");
...
//            "strField"  => "nama",
    ...
    // function paramSyncNamaNama sebelumnya tidak ada makanya label outdoor tidak sinkron.
    // sudah ditambahkan dengan ambil dari model Indoor_1 (22 nov 2023)
