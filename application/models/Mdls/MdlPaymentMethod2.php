...
class MdlPaymentMethod2 extends MdlMother
{
//    protected $tableName = "static";
    protected $tableName = "payment_methode";//difisikan biar bisa diisi default value dari selector element
