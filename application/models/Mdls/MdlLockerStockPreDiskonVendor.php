...
class MdlLockerStockPreDiskonVendor extends MdlMother
{
...
//        "produk.label",
    ...
    {
        parent::__construct();
        $this->tableName = "stock_locker_pre_diskon";
        $this->indexFields = "id";
        $this->fields = array(
            "id" => array(
                "label" => "id",
    ...
    public function cekLoker($cab, $prod, $state, $oleh = 0, $transaksi_id = 0, $gudang_id, $supplierID,$referenceID)
    {
        ...
        $this->addFilter("referensi_id='$referenceID'");
        if ($oleh != 0) {
...
//        cekBiru($this->db->last_query());
    ...
    public function fetchLockerBalance($cab, $state = "active", $gudang_id, $supplierID)
    {
        $this->addFilter("cabang_id='$cab'");
        $this->addFilter("gudang_id='$gudang_id'");
        $this->addFilter("state='$state'");
