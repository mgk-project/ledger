...
class MdlOngkir extends MdlMother
{
    ...
    protected $staticData=array(
        array(
            "id"=>"ongkir_ppn_by_cust",
            "name"=>"jasa kirim dimasukan invoice",
        ),
//        array(
//            "id"=>"ongkir_tanpa_ppn_by_cust",
//            "name"=>"jasa kirim ditalangi perusahaan(ditagih terpisah)",
//        ),

//        array(
//            "id"=>"ongkir_tanpa_ppn_by_company",
////            "name"=>"jasa kirim ditanggung perusahaan",
//            "name"=>"jasa kirim ditanggung perusahaan",
//        ),
        array(
            "id"=>"tanpa_ongkir",
