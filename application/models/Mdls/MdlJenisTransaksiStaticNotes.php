...
class MdlJenisTransaksiStaticNotes extends MdlMother_static
{
...
//            "allowed_branch" => array(25),
        ...
        array(
            "id" => "1463",
            "name" => "service purchasing(pusat)",
            "nama" => "service purchasing(pusat)",
            "label" => "service purchasing(pusat)",
            //            "allowed_branch" => array(25),
        ),
        array(
            "id" => "463",
            "name" => "service purcashing",
            "nama" => "service purcashing",
            "label" => "service purcashing",
            //            "allowed_branch" => array(25),
        ),
        array(
            "id" => "3463",
            "name" => "service purcashing project",
            "nama" => "service purcashing project",
            "label" => "service purcashing project",
            //            "allowed_branch" => array(25),
        ),
        array(
            "id" => "466",
