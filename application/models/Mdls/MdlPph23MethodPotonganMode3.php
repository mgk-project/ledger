...
class MdlPph23MethodPotonganMode3 extends MdlMother
{
...
//        "trash='0'",
    ...
    protected $fields = array(
        ...
        "kode_bayar_sendiri" => array(
            "label" => "tarif",
            "type" => "int",
            "length" => "24",
            "kolom" => "kode_bayar_sendiri",
            "inputType" => "text",
        ),
        "kode_termasuk_klaim" => array(
            "label" => "tarif",
            "type" => "int",
            "length" => "24",
            "kolom" => "kode_termasuk_klaim",
            "inputType" => "text",
        ),
    );
    protected $staticData = array(
        array(
            "id" => "1",
            "name" => "ditanggung perusahaan",
//            "tarif" => "15",
//            "tarif_label" => "2%",
            "kode_bayar_sendiri" => "1",
            "kode_termasuk_klaim" => "0",
        ),
        array(
            "id" => "2",
            "name" => "dibayar konsumen",
//            "tarif" => "15",
//            "tarif_label" => "4%",
            "kode_bayar_sendiri" => "0",
            "kode_termasuk_klaim" => "1",
        ),
    );
