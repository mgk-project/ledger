...
class MdlEmployeeFreelanceOption extends MdlMother
{

    protected $tableName = "freelancer_tipe";
    ...
    protected $fields = array(
        ...
        "name" => array(
            "label" => "name",
            "type" => "int", "length" => "255", "kolom" => "name",
            "inputType" => "text",
        ),
        "nama" => array(
            "label" => "nama",
...
//        array(
//            "id" => "1",
//            "name" => "MEMBER/TERDAFTAR",// ini tidak ada opsi tunai/bank karena masuk ke hutang komisi
////            "coa_code" => "1010010010",
//        ),
//        array(
//            "id" => "2",
//            "name" => "NON MEMBER/TIDAK TERDAFTAR",// ini nanti muncul opsi tunai/bank
////            "coa_code" => "1010010030",
//        ),
//
//    );
