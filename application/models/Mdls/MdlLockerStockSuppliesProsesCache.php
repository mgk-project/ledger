 ...
 * Time: 3:41 PM
 */
class MdlLockerStockSuppliesProsesCache extends MdlMother
{
    protected $tableName = "stock_locker_cache";
    protected $tableName_data = "supplies_proses";
    protected $filters = array("jenis='supplies_proses'");
