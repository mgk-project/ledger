...
class MdlValasSaldo extends MdlMother
{
    ...
    public function lookupByKeyword($key)
    {
        ...
        $this->db->join('_rek_pembantu_subvalas_cache', "_rek_pembantu_subvalas_cache.extern_id = $tmpTblName.currency_id and _rek_pembantu_subvalas_cache.periode = 'forever'");
