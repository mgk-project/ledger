...
class MdlUangMukaOptionPurchaseStatic extends MdlMother
{
...
//        "trash='0'",
    ...
    protected $fields = array(
        ...
        "keterangan" => array(
            "label" => "keterangan",
            "type" => "int", "length" => "24", "kolom" => "keterangan",
            "inputType" => "text",
        ),
        "jenis" => array(
            "label" => "jenis",
...
//            "keterangan" => "termasuk ppn",
        ...
        array(
            "id" => "13",
            "nama" => "jasa/service (reguler)",
//            "keterangan" => "termasuk ppn",
            "jenis" => "463o",
        ),
        array(
            "id" => "15",
            "nama" => "jasa/service (project)",
//            "keterangan" => "termasuk ppn",
            "jenis" => "3463o",
        ),
        array(
