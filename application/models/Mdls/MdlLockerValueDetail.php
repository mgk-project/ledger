...
class MdlLockerValueDetail extends MdlMother
{
...
//        "jenis='produk'",
    ...
    {
        parent::__construct();
        $this->tableName = "stock_locker_value_detail";
        $this->indexFields = "id";
        $this->fields = array(
            "id" => array(
                "label" => "id",
...
//cekBiru($this->db->last_query());
    ...
    public function lookupByKeyword($key)
    {
        ...
        $this->db->order_by("stock_locker_value_detail." . $this->sortBy['kolom'], $this->sortBy['mode']);
        $this->createSmartSearch($key, $this->listedFieldsSelectItem);
        $this->db->join('transaksi', "transaksi.id = " . $this->tableName . ".produk_id ");
...
//        $this->db->join($this->tableName, $this->tableName . ".transaksi_id = " . "transaksi.id");
        $this->db->join("transaksi", $this->tableName . ".produk_id = " . "transaksi.id");
