...
class MdlDtaBiayaUmum extends MdlMother
{

    protected $tableName = "dta_biayaumum";
...
//        "coa_code" => array("required"),
//        "division" => array("required"),
    );

    protected $listedFieldsView = array("nama", "coa_code");
    protected $fields = array(
        "id" => array(
            "label" => "id",
            "type" => "int", "length" => "255", "kolom" => "id",
...
//        "alamat" => "address",
    ...
    protected $connectingData = array(
        "MdlAccounts" => array(
             ...
             * ---------------------------------------------------------*/
            // "staticOptions" => "0603",//old
            "staticOptions" => "6030",//new coa
            "fields" => array(
                "extern_jenis" => array(
                    "str" => "rekening_in",
                ),
