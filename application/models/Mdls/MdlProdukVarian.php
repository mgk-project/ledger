...
class MdlProdukVarian extends MdlMother
{
    protected $tableName = "produk_varian";
    ...
    protected $fields = array(
        ...
        "keterangan"  => array(
            "label"     => "keterangan",
            "type"      => "varchar", "length" => "24", "kolom" => "keterangan",
            "inputType" => "text",
            //--"inputName" => "label",
        ),
        "deskripsi"  => array(
            "label"     => "deskripsi",
            "type"      => "varchar", "length" => "24", "kolom" => "deskripsi",
            "inputType" => "text",
            //--"inputName" => "label",
        ),
        // "satuan" => array(
