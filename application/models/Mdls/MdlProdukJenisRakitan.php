...
class MdlProdukJenisRakitan extends MdlMother
{
//    protected $tableName = "produk_jenis";
...
//        "produk_jenis.status='1'",
//        "produk_jenis.trash='0'"
        "term.status='1'",
        "term.trash='0'",
        "term.jenis='ppv_index'",
        "term.jenis2='produk rakitan'"
    );
