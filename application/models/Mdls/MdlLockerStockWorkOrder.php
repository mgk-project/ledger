...
class MdlLockerStockWorkOrder extends MdlMother
{
    ...
    protected $filters = array(
        "stock_locker_work_oder.jenis_locker='stock'",
        "stock_locker_work_oder.jenis='produk'",
    );
...
//        "stock_locker.satuan",
    ...
    {
        parent::__construct();
        $this->tableName = "stock_locker_work_oder";
        $this->indexFields = "id";
        $this->fields = array(
            "id" => array(
                "label" => "id",
    ...
    public function cekLoker($cab, $prod, $state, $oleh = 0, $transaksi_id = 0, $gudang_id,$project_id,$workorder_id)
    {
        $param_src = "$cab"."$gudang_id"."$project_id"."$workorder_id"."$prod"."$state";
        $this->addFilter("cabang_id='$cab'");
        $this->addFilter("gudang_id='$gudang_id'");
        $this->addFilter("produk_id='$prod'");
        $this->addFilter("project_id='$project_id'");
        $this->addFilter("work_order_id='$workorder_id'");
