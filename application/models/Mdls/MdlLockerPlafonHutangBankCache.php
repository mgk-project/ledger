 ...
 * Time: 3:41 PM
 */
class MdlLockerPlafonHutangBankCache extends MdlMother
{
    protected $tableName = "stock_locker_cache";
...
//        $this->addFilter("state='$state'");
    ...
    public function lookUpStockSumActive($cabang_id, $gudang_id, $produk_id)
    {
