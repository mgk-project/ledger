...
class MdlProduk_Paket_Project extends MdlMother
{
    ...
    public function paramSyncNamaNama()
    {
        $mdls = array(
             "MdlProdukProject" => array(
                 "id"         => "project_id",    // kolom_src => kolom_target (berisi id src)
                 // "str" => "folders_nama",
                 "kolomDatas" => array(
                     "nama" => "project_nama",       // kolom_data => kolom_target (berisi nama)
                 ),
             ),
