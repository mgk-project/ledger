...
class MdlLockerStockProjekMain extends MdlMother
{
    ...
    protected $filters = array(
        "jenis_locker='stock'",
        "stock_locker_projek.jenis='po_projek'",
    );
    ...
    protected $listedFieldsSelectItem = array(//===kolom2 yang dibaca saat searching. silahkan di-override di model masing2 jika kolomnya kurang
        "stock_locker_projek.nama",
        "stock_locker_projek.satuan",
    ...
    {
        parent::__construct();
        $this->tableName = "stock_locker_projek";
        $this->indexFields = "id";
        $this->fields = array(
            "id" => array(
                "label" => "id",
