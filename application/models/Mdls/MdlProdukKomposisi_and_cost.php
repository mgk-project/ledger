...
class MdlProdukKomposisi_and_cost extends MdlMother
{
    protected $tableName = "produk_komposisi";
    ...
    protected $filters = array(
        "produk_komposisi.status='1'",
        "produk_komposisi.trash='0'",
    );
...
//        "satuan" => "satuan",
    ...
    {
        $criteriax = array("produk_id" => $pID, "jenis" => "biaya");
        $criteria2 = "";
        // arrPrint($this->getCriteria());
        if (sizeof($this->filters) > 0) {
            $criteria = $criteriax + $this->getCriteria();
            $criteria2 = $this->getCriteria2();
        }
