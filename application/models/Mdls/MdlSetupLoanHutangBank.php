...
class MdlSetupLoanHutangBank extends MdlMother
{

    protected $tableName = "bunga_hutang_bank";
...
//        "extern_id" => array("required", "singleOnly"),
        "status" => array("required"),
        "extern_value_2" => array("extern_value_2"),
...
//        ),
        "repeat" => array(
            ...
            "inputType" => "combo",
            "dataSource" => array(1 => "setiap tgl 01"), "defaultValue" => 1,
//            "defaultValue" => "1",
//            "editable"  => false,
            //--"inputName" => "nama",
        ),
