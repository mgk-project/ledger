...
class UmComRekeningPembantuEfisiensi extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                        ...
                        $_preValues = $this->cekPreValue($key, $array_params['static']['toko_id'], $periode, $array_params['static']['extern_id']);
