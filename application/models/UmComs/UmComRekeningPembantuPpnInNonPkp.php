...
class UmComRekeningPembantuPpnInNonPkp extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_ppn_in_non_pkp_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_ppn_in_non_pkp",
            //            "cache" => "_rek_pembantu_supplier_cache",
        );
    }
...
//                    $this->tableName = $table[$key]["cache"];
                        ...
                        $_preValues = $this->cekPreValue($key, $inParams['static']['toko_id'], $periode, $inParams['static']['extern_id'], $inParams['static']['cabang_id']);
