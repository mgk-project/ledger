...
class UmComRekeningPembantuBiayaImport extends MdlMother
{
...
//                            arrPrintHijau($new_counter);
    ...
    private function cekPreValue($rek, $toko_id, $periode, $rekening_id, $cabang)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
