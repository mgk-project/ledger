...
class UmComRekeningPembantuBiayaSewa extends MdlMother
{
                    ...
                    if (sizeof($this->inParams['loop']) > 0) {
                        foreach ($this->periode as $periode) {
                            ...
                            foreach ($this->inParams['loop'] as $key => $value) {
                                ...
                                $_preValues = $this->cekPreValue($key, $this->inParams['static']['toko_id'], $periode, $this->inParams['static']['extern_id']);
...
//                            arrPrintHijau($new_counter);
    ...
    private function cekPreValue($rek, $toko_id, $periode, $pihak_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
