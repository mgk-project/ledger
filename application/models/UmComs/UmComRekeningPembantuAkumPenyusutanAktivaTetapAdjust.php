...
class UmComRekeningPembantuAkumPenyusutanAktivaTetapAdjust extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "_rek_pembantu_akumpenyuadjust_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_akumpenyuadjust",
        );
    }
