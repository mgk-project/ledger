...
class UmComRekeningPembantuEkspedisi extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_ekspedisi_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_ekspedisi",
            //            "cache" => "_rek_pembantu_ekspedisi_cache",
        );
    }
...
//                    $this->tableName = $table[$key]["cache"];
                        ...
                        $_preValues = $this->cekPreValue($key, $inParams['static']['toko_id'], $periode, $inParams['static']['extern_id']);
