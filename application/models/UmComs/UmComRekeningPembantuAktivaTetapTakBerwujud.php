...
class UmComRekeningPembantuAktivaTetapTakBerwujud extends MdlMother
{
    ...
    public function __construct()
    {
        ...
        $this->tableName = "_rek_pembantu_aktivatetaptakberwujud_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_aktivatetaptakberwujud",
