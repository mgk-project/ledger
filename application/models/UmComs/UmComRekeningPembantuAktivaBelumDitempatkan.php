...
class UmComRekeningPembantuAktivaBelumDitempatkan extends MdlMother
{
...
//                                cekKuning($insertIDs);
    ...
    private function cekPreValue($rek, $toko_id, $periode, $produk_id, $gudang_id, $cabang_id, $toko_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
