...
class UmComRekeningPembantuPendapatanLainLain extends MdlMother
{
    ...
    {
        $this->tableName = "_rek_pembantu_pendapatan_lainlain_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_pendapatan_lainlain",
        );
...
//region -- counter basic rekening
                                        $dataDetail = $this->detail[$arrayParams['static']['extern_id']];
                                        $dataDetail["extern_id"] = $arrayParams['static']['extern_id'];
...
//                            arrPrintHijau($new_counter);
    ...
    private function cekPreValue($rek, $cabang_id, $periode, $rekening_id, $toko_id)
    {
        $tgl = date("d");
        $bln = date("m");
        $thn = date("Y");
