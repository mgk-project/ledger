...
class UmComRekeningPembantuBebanLainLain extends MdlMother
{
...
//                    $this->tableName = $table[$key]["cache"];
                            ...
                            $_preValues = $this->cekPreValue($key, $arrayParams['static']['toko_id'], $periode, $externID, $arrayParams['static']['cabang_id']);
