...
class UmComRekeningPembantuSewa extends MdlMother
{
    ...
    private $tableNames = array(
        ...
        "detail" => "_rek_pembantu_sewa_cache",
    );
    ...
    {
        $this->tableName = "_rek_pembantu_sewa_cache";
        $this->tableName_master = array(
            "mutasi" => "_rek_pembantu_sewa",
        );
    }
                                ...
                                if ($pakai_cache == 1) {
                                    switch ($afterPosition) {
                                        ...
                                        case "debet":
                                            ...
                                            break;
                                        default:
                                            die(lgShowAlert(__LINE__ . " gagal menentukan posisi rekening DEBET / KREDIT " . __FUNCTION__ . " on file " . __FILE__ . "<br> | " . $key . " | - | " . $afterNumber . " |"));
                                            break;
                                    }
                                ...
                                if ($pakai_mutasi == 1) {
                                    switch ($periode) {
                                        case "forever":
                                            ...
                                            $dataDetail = $this->detail[$this->inParams['static']['extern_id']];
                                            $dataDetail["extern_id"] = $this->inParams['static']['extern_id'];
                            ...
                            if ($pakai_mutasi == 1) {
                                switch ($periode) {
                                    case "forever":
                                        ...
                                        //region -- counter basic rekening
                                        $this->main["extern_id"] = $this->inParams['static']['extern_id'];
...
//                            arrPrintHijau($new_counter);
    ...
    public function lookupJoined__()
    {
        $this->db->select("*,
            _rek_pembantu_sewa_cache.extern_id          as extern_id,
            _rek_pembantu_sewa_cache.extern_nama        as extern_nama,
            _rek_pembantu_sewa_cache.debet    as debet,
            _rek_pembantu_sewa_cache.toko_id          as toko_id");
        $criteria = array();
        $criteria2 = "";
        if (sizeof($this->filters) > 0) {
            $this->fetchCriteria();
    ...
    public function lookupPending__()
    {
        $this->db->select("*,
            _rek_pembantu_sewa_cache.extern_id          as extern_id,
            _rek_pembantu_sewa_cache.extern_nama        as extern_nama,
    ...
    public function lookupActive__()
    {
        $this->db->select("*,
        _rek_pembantu_sewa_cache.extern_id          as extern_id,
        _rek_pembantu_sewa_cache.extern_nama        as extern_nama,
