...
class PreProdukSerialNumberExtractorKonversiProduk extends CI_Model
{
                    ...
                    foreach ($_SESSION[$cCode]["items2_sum"] as $produk_id => $konversiSpec) {
                        if ($konversiSpec["kategori_nama"] == "unit") {
                            ...
                            if (isset($_SESSION[$cCode]["items4"][$produk_konversi_id])) {
                                ...
                                $pNama = $produk_konversi_nama;
                                $msg = "$produk_konversi_id SKU Indoor/Outdoor/Part dari produk $pNama tidak dikenali. Silahkan refresh halaman ini atau hubungi admin. code: " . __LINE__;
                                mati_disini($msg);
                            }
                        }
                        else {
...
//        arrPrintCyan($_SESSION[$cCode]["items3_sum"]);
