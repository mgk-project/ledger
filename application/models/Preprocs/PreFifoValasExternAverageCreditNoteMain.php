...
class PreFifoValasExternAverageCreditNoteMain extends CI_Model
{
        ...
        if (sizeof($inParams) > 0) {
            ...
            if ($run_fifo == true) {
                if ($total_kebutuhan > 0) {
                    ...
                    //-------------------------------------------------------------------------------
                    $this->load->model("Mdls/MdlFifoValasAverageExternReturn");
                    $b = new MdlFifoValasAverageExternReturn();
