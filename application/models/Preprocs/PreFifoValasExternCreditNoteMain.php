...
class PreFifoValasExternCreditNoteMain extends CI_Model
{
        ...
        if (sizeof($inParams) > 0) {
            ...
            if ($run_fifo == true) {
                if ($total_kebutuhan > 0) {
                    ...
                    $this->load->model("Mdls/MdlFifoValasExternReturn");
                    foreach ($needles as $ppID => $keperluan) {
                        $bb = new MdlFifoValasExternReturn();
...
//                    if ($keperluan > $tersedia) {
                    ...
                    $b = new MdlFifoValasExternReturn();
