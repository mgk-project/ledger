...
class PreFifoProdukKomposit extends CI_Model
{
...
// arrPrint($this->resultParams["rsltItems"]);
//             matiHEre();
            $updatePairs = array();
            $patchers = array();
...
//                    arrPrint($updatePairs);
                    ...
                    $this->load->model("Mdls/MdlFifoProdukKomposit");

                    foreach ($updatePairs as $upSpec) {
                        $updateData = $upSpec;
                        unset($updateData["id"]);

                        $b = new MdlFifoProdukKomposit();
            ...
            if (sizeof($arrFifoRsltTarget_produk) > 0) {
                foreach ($arrFifoRsltTarget_produk as $rSpec) {
                    ...
                    $patchers["rsltItems2"][$it_rsltItems2] = $hasil;
                }
            }
            //</editor-fold>
