 ...
 * Time: 9:31 PM
 */
class PreFifoAverageNonaktif extends CI_Model
{
...
//                arrPrint($sentParams);
            ...
            $this->load->model("Mdls/MdlFifoAverageNonaktif");
            foreach ($needles as $ppID => $keperluan) {
                $bb = new MdlFifoProdukJadi();
...
//                cekBiru($this->db->last_query());
            ...
            $this->load->model("Mdls/MdlFifoAverageNonaktif");
            $b = new MdlFifoAverageNonaktif();
            $b->addFilter("jenis='produk_nonaktif'");
