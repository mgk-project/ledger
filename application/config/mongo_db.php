...
//$config['mongo_db']['default']['no_auth'] = false;//punya 12
$config['mongo_db']['default']['no_auth'] = true;//punya 15
$config['mongo_db']['default']['hostname'] = '192.168.5.14';
//  $config['mongo_db']['default']['hostname'] = '192.168.11.152';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'admin';
$config['mongo_db']['default']['password'] = 'mayanet619955';
//$config['mongo_db']['default']['database'] = 'mong_san_tmp_3';
 $config['mongo_db']['default']['database'] = 'mong_san';
