        ...
        if (sizeof($_SESSION['PROED'][$prodID]['component']) > 0) {
            ...
            foreach ($_SESSION['PROED'][$prodID]['component'] as $id => $eSpec) {
                ...
                $content .= "<input type='number' tabindex='$cTab' name='harga[]' value='" . (isset($eSpec['harga'])&&$eSpec['harga']*1>0 ? $eSpec['harga']*1 : 0) . "'
                    onblur =\"top.$('#result').load('" . base_url() . "_productEditor/addItem?sID=$prodID&bID=$id&harga='+this.value);\"
                    onchange =\"top.$('#result').load('" . base_url() . "_productEditor/addItem?sID=$prodID&bID=$id&harga='+this.value);\"
                ...
                $content .= "<input type='number' tabindex='$cTab' name='jml[]' onfocus='select()' value='" . $eSpec['jml'] . "'
                    onblur =\"top.$('#result').load('" . base_url() . "_productEditor/addItem?sID=$prodID&bID=$id&jml='+this.value);\"
                    onchange =\"top.$('#result').load('" . base_url() . "_productEditor/addItem?sID=$prodID&bID=$id&jml='+this.value);\"
                    class='form-control text-right'>";
