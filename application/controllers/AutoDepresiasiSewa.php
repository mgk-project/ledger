...
//                            arrPrint($prodsDetil);
                            ...
                            cekHitam(($dateNow - $tglDepreItems) == 0 ? "(" . $prodsDetil['extern_id'] . ") $namaP | saatnya amortisasi tgl " . date('Y-m-d H:i:s') : (($dateNow - $tglDepreItems) < 0 ? "(" . $prodsDetil['extern_id'] . ") $namaP | kurang " . ($tglDepreItems - $dateNow) . " hari hingga amortisasi" : "(" . $prodsDetil['extern_id'] . ") $namaP | sudah lewat " . ($dateNow - $tglDepreItems) . " hari sejak amortisasi"));
...
//                            $comRekName_1_child = isset($staticAccountComRekening[$rekName_1_child]) ? $staticAccountComRekening[$rekName_1_child] : "";
                            $comRekName_2_child = $cabID == 25 ? $autoRekNameProduksi_lv2[$prodsDetil['rekening_main']] : $staticAccountComRekeningSales[$prodsDetil['rekening_main']];
                            $rekName_2_child = $cabID == 25 ? $prodsDetil['rekening_main'] : $prodsDetil['rekening_main'];
                            $comRekName_3_child = $cabID == 25 ? $autoRekNameProduksi_lv1[$autoRekNameProduksi_1[$prodsDetil['rekening_details']]] : $staticAccountComRekeningSales[$prodsDetil['rekening_main']];
                            $rekName_3_child = $cabID == 25 ? $autoRekNameProduksi_1[$prodsDetil['rekening_details']] : $autoRekNameSales_3[$prodsDetil['rekening_main']][$prodsDetil['rekening_details']];
...
//        if (isset($_GET['exe'])) {
matiHere('mati dulu - SAMPE BAWAH');
