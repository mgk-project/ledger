 ...
 * Time: 8:45 PM
 */
class _processSelectAktiva extends CI_Controller
{
...
//        $selectorSrcModel = $this->config->item('heTransaksi_ui')[$this->jenisTr]['selectorSrcModel'];
        ...
        $priceConfig2 = isset($this->config->item('heTransaksi_ui')[$this->jenisTr]['selectedPrice2']) ? $this->config->item('heTransaksi_ui')[$this->jenisTr]['selectedPrice2'] : array();
