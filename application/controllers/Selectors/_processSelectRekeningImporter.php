 ...
 * Time: 8:45 PM
 */
class _processSelectRekeningImporter extends CI_Controller
{
    private $rels = array();
    ...
    public function __construct()
    {
        ...
        $accountChildConfig = $this->config->item("accountChildItems");
...
//            }
        ...
        $selectorSrcModel = $index == 1 ? $this->config->item('heTransaksi_ui')[$this->jenisTr]['selectorSrcModel'] : $this->config->item('heTransaksi_ui')[$this->jenisTr]['selectorSrcModel2'];
...
//                if (!array_key_exists($index, $_SESSION[$cCode]['items'])) {
                if (!array_key_exists($id, $_SESSION[$cCode]['items'])) {
                    ...
                    $_SESSION[$cCode]['main'][$prefix . 'Position'] = detectRekDefaultPosition($_SESSION[$cCode]['main']['pihakName']);
                    $_SESSION[$cCode]['main'][$prefix . 'Account'] = $_SESSION[$cCode]['main']['pihakName'];
                    $rel = isset($this->rels[$_SESSION[$cCode]['main']['pihakName']]) ? $this->rels[$_SESSION[$cCode]['main']['pihakName']] : "";
                    $_SESSION[$cCode]['main'][$prefix . 'Rel'] = $rel;

                    $tmp[$prefix . 'Position'] = detectRekDefaultPosition($_SESSION[$cCode]['main']['pihakName']);
                    $tmp[$prefix . 'Account'] = $_SESSION[$cCode]['main']['pihakName'];
                    $tmp[$prefix . 'Rel'] = $rel;
...
//            }
        ...
        $selectorModel = $this->config->item('heTransaksi_ui')[$this->jenisTr]['selectorModel2'];
        $selectorSrcModel = $this->config->item('heTransaksi_ui')[$this->jenisTr]['selectorSrcModel2'];
...
//                $tmpJml = 1;
                ...
                if (!array_key_exists($index, $_SESSION[$cCode]['items'])) {
                    ...
                    $_SESSION[$cCode]['main']['targetAccount'] = $row->name;
//                    $_SESSION[$cCode]['out_master']['targetAccount'] = $row->name;

                    $_SESSION[$cCode]['main']['targetPosition'] = $row->defPosition;
//                    $_SESSION[$cCode]['out_master']['targetPosition'] = $row->defPosition;

                    $rel = isset($this->rels[$row->name]) ? $this->rels[$row->name] : "";
...
//                    if ($_SESSION[$cCode]['items'][$id]['debet'] > 0) {
//                        $defValue = $_SESSION[$cCode]['items'][$id]['debet'];
//                    }
//                    else {
//                        if ($_SESSION[$cCode]['items'][$id]['kredit'] > 0) {
//                            $defValue = -($_SESSION[$cCode]['items'][$id]['kredit']);
//                        }
//                    }
//                    break;
//                case "kredit":
