...
//                        $content .= "<td>-</td>";
        ...
        if (sizeof($dataExtRel) > 0) {
            ...
            foreach ($dataExtRel as $mSpec) {
                ...
                $content .= "<iframe id='result2' frameborder='0' width=100% height=100% style='width:100%;height:500px;position:relative;top:0px;left:0px;right:0px;bottom:0px;overflow:hidden;' src='" . base_url() . $mSpec['target'] . "&attached=1&sID=" . $selectedID . "&backLink=$backLink&show=1\'>";
                $content .= "</iframe>";
                if (show_debuger() == 1) {
